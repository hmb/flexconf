...
#line 96 "grammar.yxx"
    {
      ...
      {
        spGenerator->SetVariable(CGenerator::VAR_ALIAS, (yyvsp[(1) - (1)]));
      }
...
#line 115 "grammar.yxx"
    {
      ...
      spGenerator->SetVariable(CGenerator::VAR_ALIAS, (yyvsp[(4) - (4)]));
      spGenerator->VarDecl();
    }
    break;
...
#line 123 "grammar.yxx"
    {
      ...
      spGenerator->SetVariable(CGenerator::VAR_ALIAS, (yyvsp[(5) - (5)]));
      spGenerator->VarDecl();
    }
    break;
...
#line 131 "grammar.yxx"
    {
      ...
      spGenerator->SetVariable(CGenerator::VAR_SIZE, (yyvsp[(4) - (7)]));
//      if (!spGenerator->IsVariableSet(CGenerator::VAR_COUNT))
//        spGenerator->SetVariable(CGenerator::VAR_COUNT, $4);
      spGenerator->SetVariable(CGenerator::VAR_ALIAS, (yyvsp[(7) - (7)]));
